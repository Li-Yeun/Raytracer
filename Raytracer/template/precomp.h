...
inline float magnitude(const float2& v) { float len = sqrtf(v.x * v.x + v.y * v.y); return len; }
...
#define T_ typename
	...
	template<T_ A, T_ B, T_ C, T_ D, T_ E, T_ F, T_ G, T_ H, T_ I, T_ J, T_ K, T_ L, T_ M, T_ N, T_ O, T_ P, T_ Q, T_ R, T_ T, T_ U, T_ V, T_ W, T_ X, T_ Y, T_ Z, T_ AA, T_ BB, T_ CC, T_ DD, T_ EE, T_ FF, T_ GG, T_ HH>
	void SetArguments(A a, B b, C c, D d, E e, F f, G g, H h, I i, J j, K k, L l, M m, N n, O o, P p, Q q, R r, T t, U u, V v, W w , X x, Y y, Z z, AA aa, BB bb, CC cc, DD dd, EE ee, FF ff, GG gg, HH hh)
	{
		InitArgs();
		S(0, a); S(1, b); S(2, c); S(3, d); S(4, e); S(5, f); S(6, g); S(7, h);
		S(8, i); S(9, j); S(10, k); S(11, l); S(12, m), S(13, n); S(14, o), S(15, p);
		S(16, q), S(17, r), S(18, t), S(19, u), S(20, v), S(21, w), S(22, x), S(23, y), S(24, z), S(25, aa), S(26, bb), S(27, cc), S(28, dd), S(29, ee), S(30, ff), S(31, gg), S(32, hh);
	}
